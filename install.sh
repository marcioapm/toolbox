...
echo "   agent-run          — Background wrapper for coding agents"
echo "   gemini-image       — Generate images via Gemini API"
echo "   gemini-transcribe  — Transcribe audio via Gemini"
echo "   gemini-tts         — Text-to-speech via Gemini"
echo "   gemini-video       — Generate video via Veo"
echo "   gemini-vision      — Analyze images/videos via Gemini"
echo "   llm-usage          — Monitor LLM token usage across providers"
echo "   slackcli           — Lightweight Slack client"
echo "   verify-submission  — End-to-end prompt delivery verification"
echo "   opencode-gc        — Prune old opencode sessions and reclaim disk"
echo ""
